...
public class PlanClient {
    ...
    @RequestMapping(value = "/planClient-provider/tree-data-list", method = RequestMethod.POST)
    public String selectTreeDataList(@RequestBody JSONObject jsonObject) {
//        List<TreeNode> list = new ArrayList<>();
        String list = "";
        try {
            list = planBaseService.selectTreeData(jsonObject);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return list;
