...
public class Pic {
    ...
    public BufferedImage modifyImagetogeter(BufferedImage b, BufferedImage d) {
        ...
        try {
            ...
            g = d.createGraphics();
            g.drawImage(b, (dw-w)/2, (dh-h)/2, w, h, null);
            g.dispose();
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    ...
    public static void composePic(String modelPic,String pic,String newPic){
        Pic tt = new Pic();
        BufferedImage d = tt.loadImageLocal(modelPic);
        BufferedImage b = tt.loadImageLocal(pic);
        if(!new File(newPic).exists()){
            FileUtil.mkdir(newPic);
        }
        tt.writeImageLocal(newPic, tt.modifyImagetogeter(b, d));
    }
