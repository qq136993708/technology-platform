...
/**
 * out_project_check_item
 * @author 
 */
public class OutProjectCheckItem implements Serializable {
    /**
     * 主键
     */
    ...
    public boolean equals(Object that) {
        ...
        OutProjectCheckItem other = (OutProjectCheckItem) that;
        return (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId()))
            && (this.getItemMarks() == null ? other.getItemMarks() == null : this.getItemMarks().equals(other.getItemMarks()))
            ...
            && (this.getCheckDataId() == null ? other.getCheckDataId() == null : this.getCheckDataId().equals(other.getCheckDataId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getItemMarks() == null) ? 0 : getItemMarks().hashCode());
        ...
        result = prime * result + ((getCheckDataId() == null) ? 0 : getCheckDataId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", itemMarks=").append(itemMarks);
