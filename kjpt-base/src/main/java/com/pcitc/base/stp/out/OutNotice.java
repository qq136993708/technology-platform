 ...
 * @author 
 */
public class OutNotice implements Serializable {
    /**
     * 主键
     */
    ...
    public String getNoticeSystemType() {
        return noticeSystemType;
    }

    public void setNoticeSystemType(String noticeSystemType) {
        this.noticeSystemType = noticeSystemType;
    }
    ...
    public boolean equals(Object that) {
        ...
        OutNotice other = (OutNotice) that;
        return (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId()))
            ...
            && (this.getNoticeSystemType() == null ? other.getNoticeSystemType() == null : this.getNoticeSystemType().equals(other.getNoticeSystemType()))
            ...
            && (this.getNoticeContext() == null ? other.getNoticeContext() == null : this.getNoticeContext().equals(other.getNoticeContext()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getNoticeSystemType() == null) ? 0 : getNoticeSystemType().hashCode());
        ...
        result = prime * result + ((getNoticeContext() == null) ? 0 : getNoticeContext().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", noticeSystemType=").append(noticeSystemType);
        ...
        sb.append(", noticeContext=").append(noticeContext);
