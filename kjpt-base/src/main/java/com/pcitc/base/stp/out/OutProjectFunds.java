 ...
 * @author 
 */
public class OutProjectFunds implements Serializable {
    /**
     * 主键
     */
    ...
    private List<OutProjectFundsItem> itemList;
    
    public List<OutProjectFundsItem> getItemList() {
		return itemList;
	}

	public void setItemList(List<OutProjectFundsItem> itemList) {
    ...
    public String getFundsRemarks() {
        return fundsRemarks;
    }

    public void setFundsRemarks(String fundsRemarks) {
        this.fundsRemarks = fundsRemarks;
    }
    ...
    public String getFundsUnitCode() {
        return fundsUnitCode;
    }

    public void setFundsUnitCode(String fundsUnitCode) {
        this.fundsUnitCode = fundsUnitCode;
    }
    ...
    public boolean equals(Object that) {
        ...
        OutProjectFunds other = (OutProjectFunds) that;
        return (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId()))
            && (this.getFundsRemarks() == null ? other.getFundsRemarks() == null : this.getFundsRemarks().equals(other.getFundsRemarks()))
            && (this.getFundsUse() == null ? other.getFundsUse() == null : this.getFundsUse().equals(other.getFundsUse()))
            && (this.getFundsUnitCode() == null ? other.getFundsUnitCode() == null : this.getFundsUnitCode().equals(other.getFundsUnitCode()))
            && (this.getFundsUnit() == null ? other.getFundsUnit() == null : this.getFundsUnit().equals(other.getFundsUnit()))
            && (this.getFundsMoney() == null ? other.getFundsMoney() == null : this.getFundsMoney().equals(other.getFundsMoney()))
            && (this.getFundsDate() == null ? other.getFundsDate() == null : this.getFundsDate().equals(other.getFundsDate()))
            && (this.getFundsCode() == null ? other.getFundsCode() == null : this.getFundsCode().equals(other.getFundsCode()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getFundsRemarks() == null) ? 0 : getFundsRemarks().hashCode());
        result = prime * result + ((getFundsUse() == null) ? 0 : getFundsUse().hashCode());
        result = prime * result + ((getFundsUnitCode() == null) ? 0 : getFundsUnitCode().hashCode());
        result = prime * result + ((getFundsUnit() == null) ? 0 : getFundsUnit().hashCode());
        result = prime * result + ((getFundsMoney() == null) ? 0 : getFundsMoney().hashCode());
        result = prime * result + ((getFundsDate() == null) ? 0 : getFundsDate().hashCode());
        result = prime * result + ((getFundsCode() == null) ? 0 : getFundsCode().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", fundsRemarks=").append(fundsRemarks);
        sb.append(", fundsUse=").append(fundsUse);
        sb.append(", fundsUnitCode=").append(fundsUnitCode);
        sb.append(", fundsUnit=").append(fundsUnit);
        sb.append(", fundsMoney=").append(fundsMoney);
        sb.append(", fundsDate=").append(fundsDate);
        sb.append(", fundsCode=").append(fundsCode);
