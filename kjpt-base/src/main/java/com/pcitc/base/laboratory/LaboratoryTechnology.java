...
public class LaboratoryTechnology extends DataEntity implements Serializable {
    ...
    /**
     * tech_register_time - 登记时间
     */
    private String techRegisterTime;
    ...
    public String getTechRegisterTime() {
        return this.techRegisterTime;
    }

    public void setTechRegisterTime(String techRegisterTime) {
        this.techRegisterTime = techRegisterTime;
    }
    ...
    public boolean equals(Object that) {
        ...
        LaboratoryTechnology other = (LaboratoryTechnology) that;
        ...
        return
                (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId())) &&
                        ...
                        (this.getTechRegisterTime() == null ? other.getTechRegisterTime() == null : this.getTechRegisterTime().equals(other.getTechRegisterTime())) &&

                        (this.getCompletor() == null ? other.getCompletor() == null : this.getCompletor().equals(other.getCompletor())) &&
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTechRegisterTime() == null) ? 0 : getTechRegisterTime().hashCode());
        result = prime * result + ((getCompletor() == null) ? 0 : getCompletor().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", techRegisterTime=").append(techRegisterTime);
