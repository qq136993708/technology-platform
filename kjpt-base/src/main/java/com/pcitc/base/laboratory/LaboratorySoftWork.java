...
public class LaboratorySoftWork extends DataEntity implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        LaboratorySoftWork other = (LaboratorySoftWork) that;
        ...
        return
                (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId())) &&
                        ...
                        (this.getSoftTime() == null ? other.getSoftTime() == null : this.getSoftTime().equals(other.getSoftTime())) &&
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSoftTime() == null) ? 0 : getSoftTime().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", softTime=").append(softTime);
