...
public class Constants {
    ...
    public static final String START_WORKFLOW_URL = "http://kjpt-zuul/system-proxy/workflow-provider/workflow/start";
    
    public static final String AUDIT_FLAG_URL = "http://kjpt-zuul/system-proxy/task-provider/task/process/audit/flag";
