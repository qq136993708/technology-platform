...
//		try {
        ...
        String url = "http://10.225.14.211/expertFind.php";
        ...
        resultSKM = JSON.parseObject(result,ResultSKM.class);

        System.out.println(resultSKM.getCode());
        System.out.println(resultSKM.getMessage());
        System.out.println(resultSKM.getData());
//        resultSKM.setStatus(response.getCode()+"");
//        resultSKM.setMessage("success");
//        resultSKM.setData(response.getContent());
...
////            System.out.println(obj.get("companyName"));
//        }
            // 根据状态码判断请求是否成功
//        if (response.getCode() == 200) {
//            // 获取响应内容
