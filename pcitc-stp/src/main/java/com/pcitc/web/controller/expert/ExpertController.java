...
public class ExpertController extends BaseController {
	...
	@RequestMapping(value = "/expertController/test", method = RequestMethod.GET)
	public String test() {
		return "stp/expert/eee";
	}

	@RequestMapping(value = "/expertController/queryAllExpert", method = RequestMethod.GET)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/expertIndex", method = RequestMethod.GET)
	...
	public String pageExpertIndex() {
		...
		// List<ZjkChoice> listJG = (List<ZjkChoice>)
		// responseEntityJG.getBody().get("list");
		// List<ZjkChoice> unique = listJG.stream().collect(
		// Collectors.collectingAndThen(
		// Collectors.toCollection(() -> new
		// TreeSet<>(Comparator.comparing(ZjkChoice::getCompanyId))),
		// ArrayList::new)
		// );
	...
	@RequestMapping(value = "/expertController/picIndexImg", method = RequestMethod.GET)
	@ResponseBody
	...
	public Object indexPicImg() {
		...
		// return
		// JSONObject.parseObject(JSONObject.toJSONString(responseEntity.getBody().get("results"))).toString();
	}

	@RequestMapping(value = "/expertController/expertIndexNewImg", method = RequestMethod.GET)
	@OperationFilter(modelName = "专家-首页跳转", actionName = "首页跳转pageExpertIndex")
	public String expertIndexNewImg() {
		...
		// this.restTemplate.exchange(LIST_RANDOM_IMG, HttpMethod.POST, new
		// HttpEntity<ZjkExpert>(expert, this.httpHeaders), JSONObject.class);
		//
		// JSONObject retJson = responseEntity.getBody();
		// Result result = (Result) retJson.get("results");
		// request.setAttribute("results", result.getData());
	...
	@RequestMapping(value = "/expertController/expertIndexNew", method = RequestMethod.GET)
	@OperationFilter(modelName = "专家-首页跳转", actionName = "首页跳转pageExpertIndex")
	public String pageExpertIndexNew() {
		// 获取专家列表10条
		// httpHeaders.setContentType(MediaType.APPLICATION_JSON);
		// ResponseEntity<JSONObject> responseEntity =
		// this.restTemplate.exchange(LIST_RANDOM, HttpMethod.POST, new
		// HttpEntity<ZjkExpert>(new ZjkExpert(), this.httpHeaders),
		// JSONObject.class);
		// JSONObject retJson = responseEntity.getBody();
		// List<ZjkExpert> list = (List<ZjkExpert>) retJson.get("list");
	...
	@RequestMapping(value = "/expertController/expertIndexData", method = RequestMethod.POST)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/queryExpert", method = RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/bakTablePage", method = RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/bakTableData", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/queryIndex", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/expertDetail", method = RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/queryCgList", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/queryZlList", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/saveBak")
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/addCompare")
	@ResponseBody
	@OperationFilter(modelName = "专家-人员选择", actionName = "保存saveRecord")
	...
	@RequestMapping(value = "/expertController/addChoice")
	@ResponseBody
	...
	@RequestMapping(value = "/expertController/addChoiceList")
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/selectBakList", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/expertController/delBak", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/saveZjkBaseInfo")
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/picIndex", method = RequestMethod.GET)
	@ResponseBody
	@OperationFilter(modelName = "首页图形展示", actionName = "首页图形展示indexPicTwo")
	public Object indexPicTwo() {
		...
		// //添加自定义中心字段
		// String expertId = request.getParameter("expertId");
		// ResponseEntity<ZjkExpert> responseEntity =
		// this.restTemplate.exchange(GET_INFO + expertId, HttpMethod.POST, new
		// HttpEntity<String>(this.httpHeaders), ZjkExpert.class);
		// ZjkExpert zjkBaseInfo = responseEntity.getBody();
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/expertController/showExpertPage")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/expertController/zjkOutProjectList")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/expertController/zjkOutProjectListOwner")
	public String zjkOutProjectListOwner() throws Exception {
		return "/stp/expert/zjkOutProjectListOwner";
	}

	@RequestMapping(value = "/expertController/outProjectList", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/getUserChoicePage", method = RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/getUserChoiceTableData", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(method = RequestMethod.GET, value = "/expertController/expertDetailIndex")
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/personnel", method = RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/expertController/leader_speech", method = RequestMethod.GET)
