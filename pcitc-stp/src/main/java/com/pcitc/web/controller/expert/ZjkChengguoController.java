...
public class ZjkChengguoController extends BaseController {
    ...
    @ResponseBody
    @OperationFilter(modelName = "专家-成果信息", actionName = "查询列表getList")
    public Object getList(@RequestBody ZjkChengguo zjkChengguo) {
        httpHeaders.setContentType(MediaType.APPLICATION_JSON);
        ResponseEntity<JSONObject> responseEntity = this.restTemplate.exchange(LIST, HttpMethod.POST, new HttpEntity<ZjkChengguo>(zjkChengguo, this.httpHeaders), JSONObject.class);
        JSONObject retJson = responseEntity.getBody();
        List<ZjkChengguo> list = (List<ZjkChengguo>) retJson.get("list");
        return list;
    }
    ...
    @ResponseBody
    @OperationFilter(modelName = "专家-成果信息", actionName = "查询列表getListParam")
    ...
    @ResponseBody
    @OperationFilter(modelName = "专家-成果信息", actionName = "分页查询getTableData")
    ...
    public int saveRecord(ZjkChengguo record) {
        httpHeaders.setContentType(MediaType.APPLICATION_JSON);
        ...
        record.setStatus("0");
        ResponseEntity<Integer> responseEntity = this.restTemplate.exchange(SAVE, HttpMethod.POST, new HttpEntity<ZjkChengguo>(record, this.httpHeaders), Integer.class);
    ...
    public Object getzjkChengguoInfo(HttpServletRequest request) {
        ...
        ResponseEntity<ZjkChengguo> responseEntity = this.restTemplate.exchange(GET_INFO + id, HttpMethod.POST, new HttpEntity<String>(this.httpHeaders), ZjkChengguo.class);
        ZjkChengguo news = responseEntity.getBody();
        return news;
    }
