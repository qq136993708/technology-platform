...
public class ZjkExtractConfigController extends BaseController {
     ...
     * 根据ID获取对象信息
     */
    private static final String GET_INFO = "http://pcitc-zuul/system-proxy/zjkextractconfig-provider/zjkextractconfig/get-zjkextractconfig/";
    /**
     * 树形
     */
    private static final String TREE_DATA = "http://pcitc-zuul/system-proxy/zjkextractconfig-provider/zjkextractconfig/tree-data";
    /**
     * 逻辑删除
     */
    private static final String DEL = "http://pcitc-zuul/system-proxy/zjkextractconfig-provider/zjkextractconfig/del-zjkextractconfig/";
    /**
     * 物理删除
     */
    private static final String DEL_REAL = "http://pcitc-zuul/system-proxy/zjkextractconfig-provider/zjkextractconfig/del-zjkextractconfig-real/";

    /**
     * 查询列表
     */
    private static final String LIST = "http://pcitc-zuul/system-proxy/zjkextractconfig-provider/zjkextractconfig/zjkextractconfig_list";
    /**
     * 参数查询
     */
    private static final String LISTPARAM = "http://pcitc-zuul/system-proxy/zjkextractconfig-provider/zjkextractconfig/zjkextractconfig_list_param";
    /**
     * 分页查询
     */
    private static final String LISTPAGE = "http://pcitc-zuul/system-proxy/zjkextractconfig-provider/zjkextractconfig/zjkextractconfig-page";
    /**
     * 保存
     */
    private static final String SAVE = "http://pcitc-zuul/system-proxy/zjkextractconfig-provider/zjkextractconfig/save_zjkextractconfig";
    ...
    @ResponseBody
    @OperationFilter(modelName = "专家抽取逻辑配置", actionName = "查询列表getList")
    ...
    @ResponseBody
    @OperationFilter(modelName = "专家抽取逻辑配置", actionName = "查询列表getListParam")
    ...
    @ResponseBody
    @OperationFilter(modelName = "专家抽取逻辑配置", actionName = "分页查询getTableData")
    ...
    @OperationFilter(modelName = "专家抽取逻辑配置", actionName = "跳转编辑页面pageEdit")
    ...
    @OperationFilter(modelName = "专家抽取逻辑配置", actionName = "跳转列表页toListPage")
    ...
    @OperationFilter(modelName = "专家抽取逻辑配置", actionName = "根据ID查询对象信息getzjkExtractConfigInfo")
    @ResponseBody
