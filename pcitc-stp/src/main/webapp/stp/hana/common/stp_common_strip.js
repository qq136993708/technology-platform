		...
		success : function(data, status) {
			if (data.success == true || data.success == 'true') {
				...
				for (var i = 0; i < seriesDataList.length; i++) {
					// seriesDataList[i].barWidth = 10;
					series.push(seriesDataList[i]);
				}
				console.log("series11111");
				console.log(series);
 ...
 * @returns
 */
function load_single_bar(url, id, title, subtext, xAxis, color, width, rotate, callback) {
