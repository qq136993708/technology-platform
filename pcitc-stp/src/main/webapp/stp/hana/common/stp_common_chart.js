 ...
 * 标志柱状图
 * 
 * @type {{title: {text: string, x: string}, tooltip: {trigger: string}, legend:
 *       {bottom: number, data: Array}, xAxis: {type: string, data: Array},
	...
	$.ajax({
		...
		success : function(data, status) {
			if (data.success == true || data.success == 'true') {
				...
				// var
				// legendDataList=JSON.stringify(result.returnData.chart1.legendDataList);
