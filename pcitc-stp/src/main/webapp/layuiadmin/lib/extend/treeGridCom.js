...
layui.config({
    ...
    Class.prototype.treeConvertShowName=function (o) {
        ...
        var temhtml='<div style="float: left;height: 32px;line-height: 32px;padding-left: '+
            ...
            +function () {//图标或占位符
                var temTreeHtml='';
                var temTreeIsOpen=o[table.config.cols.isOpen]?"<img src='/layuiadmin/layui/images/icon_minus.png'/>":"<img src='/layuiadmin/layui/images/icon_add.png'/>";
                if(isTreeNode){//父节点
    ...
    Class.prototype.treeNodeOpen=function (o,isOpen) {
        ...
        if(o[table.config.cols.isOpen]){//打开状态
            //dbClickI.html('&#xe625;');
            dbClickI.html('<img src="/layuiadmin/layui/images/icon_minus.png"/>');
            //alert('动态查询id为:'+o.id+"节点下的数据");
            // 向后台发送请求获取到该节点下的所有子节点同时查子节点的子节点
        }else{
            dbClickI.html('<img src="/layuiadmin/layui/images/icon_add.png"/>');
            //dbClickI.html('&#xe623;');
        }
    };
        ...
        if(iconOpen){
            ...
            if(isTreeNode){//父节点
                ...
                if(o[table.config.cols.icon]){
                    ...
                    temTreeHtml+='<i class="layui-icon layui-tree-'+o[options.idField]+' layui-tree-leaf"  '+iconOpen+'><img src="/layuiadmin/layui/images/icon_spot.png"/></i>';
                }
            }
            if(isHtml){
                return temTreeHtml;
