...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
	...
	j.prototype.config = {
		...
		a.height && /^full-\d+$/.test(a.height) && (e.fullHeightGap = a.height.split("-")[1], a.height = _.height() - e.fullHeightGap), e.setInit();
		var l = a.elem,
			n = l.next("." + f),
		...
		var e, t = this,
			i = t.config,
			a = i.height;
		t.fullHeightGap && (a = _.height() - t.fullHeightGap, a < 135 && (a = 135), t.elem.css("height", a)), a && (e = parseFloat(a) - (t.layHeader.outerHeight() || 38), i.toolbar && (e -= t.layTool.outerHeight() || 50), i.totalRow && (e -= t.layTotal.outerHeight() || 40), i.page && (e = e - (t.layPage.outerHeight() || 41) - 2), t.layMain.css("height", e))
