    ...
    jQuery(function() {
        ...
        Dragfn.prototype = {
            ...
            pointDrag: function(obj){
                ...
                if(obj.classList[0]=="mc-visualization"){
                    if(oNear.classList[0]=="mc-decision-center"){
                        self.aPos[3].left=394;
                    }else if(oNear.classList[0]=="mc-mail"){
                        $(".mc-standby-management").removeClass("col-md-6");
                        $(".mc-standby-management").addClass("col-md-8");
                        $(".mc-news").removeClass("col-md-8");
                        $(".mc-news").addClass("col-md-6");
                        $(".mc-visualization").removeClass("col-md-8");
                        $(".mc-visualization").addClass("col-md-6");
                        $(".main-sidebar .content-wrapper .mc-visualization .left").css({width:"36%"});
                        $(".main-sidebar .content-wrapper .mc-visualization .right").css({width:"64%"});
                        self.aPos[1].left=637;
                    }else if(oNear.classList[0]=="mc-quota"){
                        $(".mc-news").removeClass("col-md-6");
                        $(".mc-news").addClass("col-md-8");
                        $(".mc-standby-management").removeClass("col-md-8");
                        $(".mc-standby-management").addClass("col-md-6");
                        $(".mc-visualization").removeClass("col-md-8");
                        $(".mc-visualization").addClass("col-md-6");
                        $(".main-sidebar .content-wrapper .mc-visualization .left").css({width:"36%"});
                        $(".main-sidebar .content-wrapper .mc-visualization .right").css({width:"64%"});
                        self.aPos[1].left=843;
                        self.aPos[0].left=637;
                        if($(".mc-quota").css("top")=="301px"){
                            console.log(self.aPos)
                            $(".mc-news").removeClass("col-md-8");
                            $(".mc-news").addClass("col-md-6");
                            $(".mc-standby-management").removeClass("col-md-6");
                            $(".mc-standby-management").addClass("col-md-8");
                            self.aPos[0].left=843;
                            self.aPos[1].left=637;
                        }
                    }
                }
                /*if(((obj.classList[1]=="col-md-8" ||obj.classList[2]=="col-md-6") && oNear.classList[1]=="col-md-4")){
                    console.log(oNear.classList[0]);
                    //判断科技项目全流程可视化 移动后的布局
                    if(oNear.classList[0]=="mc-mail"){
                        $(".mc-news").removeClass("col-md-8");
                        $(".mc-news").addClass("col-md-6");
                        $(".mc-visualization").removeClass("col-md-8");
                        $(".mc-visualization").addClass("col-md-6");
                ...
                }else if ((obj.classList[1]=="col-md-4" && oNear.classList[1]=="col-md-8")){
                    self.aPos[3].left=394
                }*/
                //判断决策中心移动后的布局
