...
{
	private static final String ${svcPrefix}_GET = "http://kjpt-zuul/stp-proxy/stp-provider/budget/${svcPath}-get/";
	private static final String ${svcPrefix}_LIST = "http://kjpt-zuul/stp-proxy/stp-provider/budget/${svcPath}-list";
	private static final String ${svcPrefix}_TABLE = "http://kjpt-zuul/stp-proxy/stp-provider/budget/${svcPath}-table";
	private static final String ${svcPrefix}_SAVE = "http://kjpt-zuul/stp-proxy/stp-provider/budget/${svcPath}-save";
	private static final String ${svcPrefix}_UPD = "http://kjpt-zuul/stp-proxy/stp-provider/budget/${svcPath}-upd";
	private static final String ${svcPrefix}_SAVEORUPD = "http://kjpt-zuul/stp-proxy/stp-provider/budget/${svcPath}-saveorupd";
	private static final String ${svcPrefix}_DEL = "http://kjpt-zuul/stp-proxy/stp-provider/budget/${svcPath}-del/";
