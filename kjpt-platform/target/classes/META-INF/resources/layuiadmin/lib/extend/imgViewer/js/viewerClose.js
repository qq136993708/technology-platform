...
(function (global, factory) {
  ...
  var DEFAULTS = {
    ...
    // Show the title —— 显示当前图片的标题（现实 alt 属性及图片尺寸）
    title: true,
    ...
    // The amount of time to delay between automatically cycling an image when playing.—— 播放间隔，单位为毫秒
    interval: 5000,

    // Enable keyboard support —— 是否支持键盘
    keyboard: true,

    // Enable a modal backdrop, specify `static` for a backdrop which doesn't close the modal on click —— 是否采用模态框背景
    backdrop: true,
