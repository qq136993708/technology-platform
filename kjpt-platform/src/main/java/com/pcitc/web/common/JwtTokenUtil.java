...
public class JwtTokenUtil implements Serializable {
	...
	private static final String CLAIM_KEY_USER_UNIT_ROLE = "userRole";
	private static final String CLAIM_KEY_USER_UNIT_ROLE_TEXT = "userRoleText";
	...
	public static SysUser getUserFromToken(HttpHeaders httpHeaders) {
		...
		// token =
		// "Bearer eyJhbGciOiJIUzUxMiJ9.eyJ1c2VyTmFtZSI6IjEyMzQ1NiIsInJvbGVMaXN0IjpbXSwiZXhwIjoxNTM2MTMyODgxLCJ1c2VySWQiOiIxMjMifQ.g43ZCnLCty3Whzr4gb3jnS3bRxWxbujIFFQuru5Yxcs3GszG1R8MX4Axo2S-psRigIKrD8o4CTTk2nBmBHMhHw";
		Claims claims;
		try {
		...
		if (claims != null) {
			...
			user.setUserUnit(claims.get(CLAIM_KEY_UNITID) != null ? claims.get(CLAIM_KEY_UNITID).toString() : null);
			...
			user.setUserRole(claims.get(CLAIM_KEY_USER_UNIT_ROLE) != null ? claims.get(CLAIM_KEY_USER_UNIT_ROLE).toString() : null);
			user.setUserRoleText(claims.get(CLAIM_KEY_USER_UNIT_ROLE_TEXT) != null ? claims.get(CLAIM_KEY_USER_UNIT_ROLE_TEXT).toString() : null);
	...
	/**
	 * @author zhf
	 * @date 2018年5月15日 上午10:43:46 token中不包含Bearer
	 */
