...
public class SciencePlanPoiExcelUtil<T> {
    // excle导出名称
    ...
    // 构造函数
    public SciencePlanPoiExcelUtil(String fileName, String[] heads, String[] cols, List<T> list, OutputStream out)
    {
    ...
    // 构造函数 带数字类型
    public SciencePlanPoiExcelUtil(String fileName, String[] heads, String[] cols, List<T> list, int[] numerics, OutputStream out) {
        this.fileName = fileName;
        this.heads = heads;
        this.cols = cols;
        this.list = list;
    ...
    public SciencePlanPoiExcelUtil(String fileName, String[] heads, String[] cols, List<T> list, int colNum, OutputStream out) {
        this.fileName = fileName;
        this.heads = heads;
        this.cols = cols;
        this.list = list;
                ...
                for (int k = 0; k < cols.length; k++) {
                    ...
                    if(o!=null)
                    {
                        if(o instanceof Date ){
                            if(k==colNum){
                                value = DateUtil.dateToStr((Date) o,DateUtil.FMT_MMM);
                            }else{
