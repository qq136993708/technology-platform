...
public class WorkflowController extends BaseController {
	...
	private static final String FUNCTION_PROCESS_DEFINE_PAGE = "http://kjpt-zuul/system-proxy/workflow-provider/function/process-list";
	private static final String FUNCTION_PROCESS_DEFINE_ADD = "http://kjpt-zuul/system-proxy/workflow-provider/function/add-config";

	private static final String FUNCTION_CONFIG_DEL = "http://kjpt-zuul/system-proxy/workflow-provider/function/configures";

	private final static String PROCESS_DEF_LIST = "http://kjpt-zuul/system-proxy/workflow-provider/process/defines/list";
	...
	public Result startFlow2(@RequestBody String param, HttpServletRequest request) {
		...
		variables.put("auditRejectMethod", "http://kjpt-zuul/system-proxy/workflow-provider/task/reject/" + businessId);
