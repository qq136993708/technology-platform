...
public class DelegateController extends BaseController {
	...
	// 委托单列表
	private static final String DELEGATE_PAGE_URL = "http://kjpt-zuul/system-proxy/task-provider/assignees/delegates";

	// 新增委托
	private static final String DELEGATE_ADD_URL = "http://kjpt-zuul/system-proxy/task-provider/delegate/add";
	
	// 删除委托
	private static final String DELEGATE_DEL_URL = "http://kjpt-zuul/system-proxy/task-provider/delegates/delete";
