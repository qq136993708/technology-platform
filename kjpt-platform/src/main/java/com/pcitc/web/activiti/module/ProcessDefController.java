...
public class ProcessDefController extends BaseController {
	...
	private static final String PROCESS_DEFINE_LIST = "http://kjpt-zuul/system-proxy/modeler-provider/process/define/list";
	private static final String PROCESS_DEFINE_STATE = "http://kjpt-zuul/system-proxy/modeler-provider/process/define/state";
	private static final String PROCESS_DEFINE_DEL = "http://kjpt-zuul/system-proxy/modeler-provider/process/define/delete";
	private static final String PROCESS_DEFINE_IMAGE = "http://kjpt-zuul/system-proxy/modeler-provider/process/show";
