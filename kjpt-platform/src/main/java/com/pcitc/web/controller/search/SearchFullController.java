...
public class SearchFullController extends BaseController {
    ...
    private static final String common_table = "http://kjpt-zuul/system-proxy/search/getTableDataScientific";
    private static final String contract_dic = "http://kjpt-zuul/system-proxy/out-project-provider/select-condition/list";

    private static final String getAwardTable = "http://kjpt-zuul/system-proxy/search/getTableDataAchivement";
    private static final String getTableSearchEquipment = "http://kjpt-zuul/system-proxy/search/getTableSearchEquipment";
    private static final String getTableDataReport = "http://kjpt-zuul/system-proxy/search/getTableDataReport";
    private static final String getOutRewardTable = "http://kjpt-zuul/system-proxy/search/reward-list";

    private static final String search = "http://kjpt-zuul/system-proxy/search/search";

    private static final String equipment_02 = "http://kjpt-zuul/hana-proxy/hana/home/get_home_KYZB_02";
    ...
    //保存搜索日志
    private static final String SAVE_SEARCH_LOG = "http://kjpt-zuul/system-proxy/zjksearchlog-provider/zjksearchlog/save_zjksearchlog";
