...
public class RoleController extends BaseController {
	...
	private static final String ROLE_GET_ROLE = "http://kjpt-zuul/system-proxy/role-provider/role/get-role/";
	private static final String ROLE_LIST_DATA = "http://kjpt-zuul/system-proxy/role-provider/role/role-list";
	private static final String ROLE_LIST_ALL_DATA = "http://kjpt-zuul/system-proxy/role-provider/role/role-list-all";
	private static final String ROLE_ADD_ROLE = "http://kjpt-zuul/system-proxy/role-provider/role/add-role";
	private static final String ROLE_UPDATE_ROLE = "http://kjpt-zuul/system-proxy/role-provider/role/upd-role";
	private static final String ROLE_DEL_ROLE = "http://kjpt-zuul/system-proxy/role-provider/role/del-role/";
	private static final String ROLE_DEL_ROLE_REAL = "http://kjpt-zuul/system-proxy/role-provider/role/del-role-real/";
	private static final String ROLE_USER_REL_ADD = "http://kjpt-zuul/system-proxy/role-provider/role/user-role-add";
	private static final String ROLE_USER_REL_DEL = "http://kjpt-zuul/system-proxy/role-provider/role/user-role-del";
	private static final String ROLE_FUNC_REL_TREE = "http://kjpt-zuul/system-proxy/role-provider/role/role-func-tree/";
	private static final String ROLE_CODE = "http://kjpt-zuul/system-proxy/role-provider/role/role-code";
