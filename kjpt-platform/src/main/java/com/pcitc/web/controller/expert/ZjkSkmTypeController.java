...
public class ZjkSkmTypeController extends BaseController {
     ...
     * 根据ID获取对象信息
     */
    private static final String GET_INFO = "http://kjpt-zuul/system-proxy/zjkskmtype-provider/zjkskmtype/get-zjkskmtype/";
    /**
     * 树形
     */
    private static final String TREE_DATA = "http://kjpt-zuul/system-proxy/zjkskmtype-provider/zjkskmtype/tree-data";
    /**
     * 逻辑删除
     */
    private static final String DEL = "http://kjpt-zuul/system-proxy/zjkskmtype-provider/zjkskmtype/del-zjkskmtype/";
    /**
     * 物理删除
     */
    private static final String DEL_REAL = "http://kjpt-zuul/system-proxy/zjkskmtype-provider/zjkskmtype/del-zjkskmtype-real/";

    /**
     * 查询列表
     */
    private static final String LIST = "http://kjpt-zuul/system-proxy/zjkskmtype-provider/zjkskmtype/zjkskmtype_list";
    /**
     * 参数查询
     */
    private static final String LISTPARAM = "http://kjpt-zuul/system-proxy/zjkskmtype-provider/zjkskmtype/zjkskmtype_list_param";
    /**
     * 分页查询
     */
    private static final String LISTPAGE = "http://kjpt-zuul/system-proxy/zjkskmtype-provider/zjkskmtype/zjkskmtype-page";
    /**
     * 保存
     */
    private static final String SAVE = "http://kjpt-zuul/system-proxy/zjkskmtype-provider/zjkskmtype/save_zjkskmtype";
