...
public class SysFileCollectController extends BaseController {
	...
	private static final String GET_INFO = "http://kjpt-zuul/system-proxy/sysfilecollect-provider/sysfilecollect/get-sysfilecollect/";
	private static final String TREE_DATA = "http://kjpt-zuul/system-proxy/sysfilecollect-provider/sysfilecollect/tree-data";
	private static final String ADD = "http://kjpt-zuul/system-proxy/sysfilecollect-provider/sysfilecollect/add-sysfilecollect";
	private static final String UPDATE = "http://kjpt-zuul/system-proxy/sysfilecollect-provider/sysfilecollect/update-sysfilecollect";
	private static final String DEL = "http://kjpt-zuul/system-proxy/sysfilecollect-provider/sysfilecollect/del-sysfilecollect/";
	private static final String DEL_REAL = "http://kjpt-zuul/system-proxy/sysfilecollect-provider/sysfilecollect/del-sysfilecollect-real/";

	/**
	 * 标准增删改查
	 */
	private static final String LIST = "http://kjpt-zuul/system-proxy/sysfilecollect-provider/sysfilecollect/sysfilecollect_list";
	private static final String LISTPARAM = "http://kjpt-zuul/system-proxy/sysfilecollect-provider/sysfilecollect/sysfilecollect_list_param";

	private static final String LISTPAGE = "http://kjpt-zuul/system-proxy/sysfilecollect-provider/sysfilecollect/sysfilecollect-page";

	private static final String SAVE = "http://kjpt-zuul/system-proxy/sysfilecollect-provider/sysfilecollect/save_sysfilecollect";

	private static final String DELETE_COLLECT = "http://kjpt-zuul/system-proxy/sysfilecollect-provider/sysfilecollect/delete_sysfilecollect";

	private static final String GET = "http://kjpt-zuul/system-proxy/sysfilecollect-provider/sysfilecollect/get_sysfilecollect/";
