...
public class TechFamilyTypeController extends BaseController {
     ...
     * 根据ID获取对象信息
     */
    private static final String GET_INFO = "http://kjpt-zuul/stp-proxy/techfamilytype-provider/techfamilytype/get-techfamilytype/";
    /**
     * 树形
     */
    private static final String TREE_DATA = "http://kjpt-zuul/stp-proxy/techfamilytype-provider/techfamilytype/tree-data";
    /**
     * 逻辑删除
     */
    private static final String DEL = "http://kjpt-zuul/stp-proxy/techfamilytype-provider/techfamilytype/del-techfamilytype/";
    /**
     * 物理删除
     */
    private static final String DEL_REAL = "http://kjpt-zuul/stp-proxy/techfamilytype-provider/techfamilytype/del-techfamilytype-real/";

    /**
     * 查询列表
     */
    private static final String LIST = "http://kjpt-zuul/stp-proxy/techfamilytype-provider/techfamilytype/techfamilytype_list";
    /**
     * 参数查询
     */
    private static final String LISTPARAM = "http://kjpt-zuul/stp-proxy/techfamilytype-provider/techfamilytype/techfamilytype_list_param";
    /**
     * 分页查询
     */
    private static final String LISTPAGE = "http://kjpt-zuul/stp-proxy/techfamilytype-provider/techfamilytype/techfamilytype-page";
    /**
     * 保存
     */
    private static final String SAVE = "http://kjpt-zuul/stp-proxy/techfamilytype-provider/techfamilytype/save_techfamilytype";
