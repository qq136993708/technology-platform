...
public class ExpertRewardController extends BaseController {
	...
	/**
	  * 获取专家奖励（分页）
	 */
    @ApiOperation(value = "获取专家奖励列表（分页）", notes = "获取专家奖励列表（分页）")
	...
	public String getExpertPage(
            ...
            @RequestParam(required = false,value="专家奖励编号") String num,
	...
	@RequestMapping(value = "/expert-reward-api/delete/{id}", method = RequestMethod.DELETE)
