...
public class SysAddressController extends BaseController {
     ...
     * 根据ID获取对象信息
     */
    private static final String GET_INFO = "http://kjpt-zuul/system-proxy/sysaddress-provider/sysaddress/get-sysaddress/";
    /**
     * 树形
     */
    private static final String TREE_DATA = "http://kjpt-zuul/system-proxy/sysaddress-provider/sysaddress/tree-data";
    /**
     * 逻辑删除
     */
    private static final String DEL = "http://kjpt-zuul/system-proxy/sysaddress-provider/sysaddress/del-sysaddress/";
    /**
     * 物理删除
     */
    private static final String DEL_REAL = "http://kjpt-zuul/system-proxy/sysaddress-provider/sysaddress/del-sysaddress-real/";

    /**
     * 查询列表
     */
    private static final String LIST = "http://kjpt-zuul/system-proxy/sysaddress-provider/sysaddress/sysaddress_list";
    /**
     * 参数查询
     */
    private static final String LISTPARAM = "http://kjpt-zuul/system-proxy/sysaddress-provider/sysaddress/sysaddress_list_param";
    /**
     * 分页查询
     */
    private static final String LISTPAGE = "http://kjpt-zuul/system-proxy/sysaddress-provider/sysaddress/sysaddress-page";
    /**
     * 保存
     */
    private static final String SAVE = "http://kjpt-zuul/system-proxy/sysaddress-provider/sysaddress/save_sysaddress";
