...
public class StandardBaseExpertController extends BaseController {
     ...
     * 根据ID获取对象信息
     */
    private static final String GET_INFO = "http://kjpt-zuul/system-proxy/standardbase-provider/standardbase/get-standardbase/";
    /**
     * 树形
     */
    private static final String TREE_DATA = "http://kjpt-zuul/system-proxy/standardbase-provider/standardbase/tree-data";
    /**
     * 逻辑删除
     */
    private static final String DEL = "http://kjpt-zuul/system-proxy/standardbase-provider/standardbase/del-standardbase/";
    /**
     * 物理删除
     */
    private static final String DEL_REAL = "http://kjpt-zuul/system-proxy/standardbase-provider/standardbase/del-standardbase-real/";

    /**
     * 查询列表
     */
    private static final String LIST = "http://kjpt-zuul/system-proxy/standardbase-provider/standardbase/standardbase_list";
    /**
     * 参数查询
     */
    private static final String LISTPARAM = "http://kjpt-zuul/system-proxy/standardbase-provider/standardbase/standardbase_list_param";
    /**
     * 分页查询
     */
    private static final String LISTPAGE = "http://kjpt-zuul/system-proxy/standardbase-provider/standardbase/standardbase-page";
    /**
     * 保存
     */
    private static final String SAVE = "http://kjpt-zuul/system-proxy/standardbase-provider/standardbase/save_standardbase";

    private static final String importFileStandard = "http://kjpt-zuul/system-proxy/planClient-provider/importFileStandard";
    private static final String importFileTfc = "http://kjpt-zuul/system-proxy/planClient-provider/importFileTfc";
    private static final String TECH_TYPE_ADD_LIST = "http://kjpt-zuul/stp-proxy/tech-family-provider/type-insert-list";
...
//        request.setAttribute("name",outProjectInfo.get("name"));
    ...
    public String tfcTj() throws Exception {
       ...
       // ResponseEntity<OutProjectInfo> responseEntity = this.restTemplate.exchange(GET_OUT_PROJECT + dataId, HttpMethod.POST, new HttpEntity<String>(this.httpHeaders), OutProjectInfo.class);
        //OutProjectInfo outProjectInfo =null;// responseEntity.getBody();
        //获取分词
    ...
    private static final String GET_OUT_PROJECT = "http://kjpt-zuul/system-proxy/out-provider/get-project-list-fc/";
    private static final String GET_OUT_PROJECT_COUNT = "http://kjpt-zuul/system-proxy/out-provider/get-project-list-count/";
    private static final String GET_TFC_PROJECT = "http://kjpt-zuul/stp-proxy/tech-family-provider/get-tfc-project";
