...
public class SysFileConfigController extends BaseController {
	...
	private static final String GET = "http://kjpt-zuul/system-proxy/sysfileconfig-provider/sysfileconfig/get-sysfileconfig/";
	private static final String TREE_DATA = "http://kjpt-zuul/system-proxy/sysfileconfig-provider/sysfileconfig/tree-data";
	private static final String ADD = "http://kjpt-zuul/system-proxy/sysfileconfig-provider/sysfileconfig/add-sysfileconfig";
	private static final String UPDATE = "http://kjpt-zuul/system-proxy/sysfileconfig-provider/sysfileconfig/update-sysfileconfig";
	private static final String DEL = "http://kjpt-zuul/system-proxy/sysfileconfig-provider/sysfileconfig/del-sysfileconfig/";
	private static final String DEL_REAL = "http://kjpt-zuul/system-proxy/sysfileconfig-provider/sysfileconfig/del-sysfileconfig-real/";

	private static final String getFileConfig = "http://kjpt-zuul/system-proxy/sysfileconfig-provider/sysfileconfig/getFileConfig/";
