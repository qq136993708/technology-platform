...
public class ZjkMsgController extends BaseController {
     ...
     * 根据ID获取对象信息
     */
    private static final String GET_INFO = "http://kjpt-zuul/stp-proxy/zjkmsg-provider/zjkmsg/get-zjkmsg/";
    /**
     * 树形
     */
    private static final String TREE_DATA = "http://kjpt-zuul/stp-proxy/zjkmsg-provider/zjkmsg/tree-data";
    /**
     * 逻辑删除
     */
    private static final String DEL = "http://kjpt-zuul/stp-proxy/zjkmsg-provider/zjkmsg/del-zjkmsg/";
    /**
     * 物理删除
     */
    private static final String DEL_REAL = "http://kjpt-zuul/stp-proxy/zjkmsg-provider/zjkmsg/del-zjkmsg-real/";

    /**
     * 查询列表
     */
    private static final String LIST = "http://kjpt-zuul/stp-proxy/zjkmsg-provider/zjkmsg/zjkmsg_list";
    /**
     * 参数查询
     */
    private static final String LISTPARAM = "http://kjpt-zuul/stp-proxy/zjkmsg-provider/zjkmsg/zjkmsg_list_param";
    /**
     * 分页查询
     */
    private static final String LISTPAGE = "http://kjpt-zuul/stp-proxy/zjkmsg-provider/zjkmsg/zjkmsg-page";

    private static final String getTableDataTrees = "http://kjpt-zuul/stp-proxy/zjkmsg-provider/zjkmsg/getTableDataTrees";
    private static final String getTableDataTreesCg = "http://kjpt-zuul/stp-proxy/zjkmsg-provider/zjkmsg/getTableDataTreesCg";
    private static final String getTableDataTreesJl = "http://kjpt-zuul/stp-proxy/zjkmsg-provider/zjkmsg/getTableDataTreesJl";
    /**
     * 保存
     */
    private static final String SAVE = "http://kjpt-zuul/stp-proxy/zjkmsg-provider/zjkmsg/save_zjkmsg";
    /**
     * 批量保存
     */
    private static final String SAVE_BAT = "http://kjpt-zuul/stp-proxy/zjkmsgconfig-provider/zjkmsgconfig/save_zjkmsgconfig_bat";
