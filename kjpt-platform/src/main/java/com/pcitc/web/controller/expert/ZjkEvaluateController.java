...
public class ZjkEvaluateController extends BaseController {
     ...
     * 根据ID获取对象信息
     */
    private static final String GET_INFO = "http://kjpt-zuul/stp-proxy/zjkevaluate-provider/zjkevaluate/get-zjkevaluate/";
    
    private static final String GET_INFO_BYZJKID = "http://kjpt-zuul/stp-proxy/zjkevaluate-provider/zjkevaluate/get-zjkevaluate-byzjkid/";
    
   
    /**
     * 树形
     */
    private static final String TREE_DATA = "http://kjpt-zuul/stp-proxy/zjkevaluate-provider/zjkevaluate/tree-data";
    /**
     * 逻辑删除
     */
    private static final String DEL = "http://kjpt-zuul/stp-proxy/zjkevaluate-provider/zjkevaluate/del-zjkevaluate/";
    /**
     * 物理删除
     */
    private static final String DEL_REAL = "http://kjpt-zuul/stp-proxy/zjkevaluate-provider/zjkevaluate/del-zjkevaluate-real/";

    /**
     * 查询列表
     */
    private static final String LIST = "http://kjpt-zuul/stp-proxy/zjkevaluate-provider/zjkevaluate/zjkevaluate_list";
    /**
     * 参数查询
     */
    private static final String LISTPARAM = "http://kjpt-zuul/stp-proxy/zjkevaluate-provider/zjkevaluate/zjkevaluate_list_param";
    /**
     * 分页查询
     */
    private static final String LISTPAGE = "http://kjpt-zuul/stp-proxy/zjkevaluate-provider/zjkevaluate/zjkevaluate-page";
    /**
     * 保存
     */
    private static final String SAVE = "http://kjpt-zuul/stp-proxy/zjkevaluate-provider/zjkevaluate/save_zjkevaluate";
