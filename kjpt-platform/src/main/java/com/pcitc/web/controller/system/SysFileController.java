...
public class SysFileController extends BaseController {
    ...
    private static final String LIST = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/list";

    private static final String getTableData = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/getTableData";

    private static final String getTableDataEs = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/getTableDataEs";
    private static final String getTableDataEsIndex = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/getTableDataEsIndex";

    private static final String GET = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/get-sysfile/";
    private static final String TREE_DATA = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/tree-data";
    private static final String ADD = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/add-sysfile";
    private static final String UPDATE = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/update-sysfile";
    private static final String DEL = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/del-sysfile/";
    private static final String DEL_REAL = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/del-sysfile-real/";
    /**
     * 更新文件状态
     */
    private static final String UPDATE_FILE_FLAG = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/update-file-flag/";
    /**
     * 删除表单文件
     */
    private static final String DELETE_FILE_FORM = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/delete-form-file/";

    private static final String avatarUpload = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/avatarUpload";
    /**
     * markdown组件上传图片
     */
    private static final String markdownUpload = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/markdownUpload";
    /**
     * 跳转到通用文件上传窗口
     */
    private static final String uploader = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/uploader";
    /**
     * 通用文件上传接口，存储到固定地址，以后存储到文件服务器地址
     */
    private static final String uploadFile = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/uploadFile";
    /**
     * 多文件上传，用于uploadAsync=false(同步多文件上传使用)
     */
    private static final String uploadMultipleFile = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/uploadMultipleFile";
    /**
     * 删除某一项文件
     */
    private static final String delete = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/delete";
    /**
     * 下载
     */
    private static final String download = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/download/";
    private static final String video = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/video/";
    private static final String downloads = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/downloads/";
    private static final String previewImgagByByteBase64 = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/previewImgagByByteBase64/";
    private static final String showFlag = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/showFlag/";
    /**
     * 获取字体图标map,base-file控件使用
     */
    private static final String icons = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/icons";
    /**
     * 获取上传文件
     */
    private static final String getFiles = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/getFiles";
    ...
    private static final String getFilesLayuiByFormIdOss = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/getFilesLayuiByFormIdOss";
    /**
     * 组装展示页面
     */
    private static final String getPreivewSettings = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/getPreivewSettings";
    /**
     * 单文件上传获取文件信息
     */
    private static final String uploadFileSave = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/uploadFileSave";

    private static final String uploadFileSavetest = "http://kjpt-zuul/system-proxy/sysfile-provider/sysfile/uploadFileSavetest";
    ...
    private static final String commonFileList = "http://kjpt-zuul/system-proxy/file-common-provider/files/common/data-list";
