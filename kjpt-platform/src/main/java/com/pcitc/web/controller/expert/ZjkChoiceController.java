...
public class ZjkChoiceController extends BaseController {
     ...
     * 根据ID获取对象信息
     */
    private static final String GET_INFO = "http://kjpt-zuul/stp-proxy/zjkchoice-provider/zjkchoice/get-zjkchoice/";
    /**
     * 树形
     */
    private static final String TREE_DATA = "http://kjpt-zuul/stp-proxy/zjkchoice-provider/zjkchoice/tree-data";
    /**
     * 逻辑删除
     */
    private static final String DEL = "http://kjpt-zuul/stp-proxy/zjkchoice-provider/zjkchoice/del-zjkchoice/";
    /**
     * 物理删除
     */
    private static final String DEL_REAL = "http://kjpt-zuul/stp-proxy/zjkchoice-provider/zjkchoice/del-zjkchoice-real/";

    /**
     * 查询列表
     */
    private static final String LIST = "http://kjpt-zuul/stp-proxy/zjkchoice-provider/zjkchoice/zjkchoice_list";
    /**
     * 参数查询
     */
    private static final String LISTPARAM = "http://kjpt-zuul/stp-proxy/zjkchoice-provider/zjkchoice/zjkchoice_list_param";
    /**
     * 分页查询,返回项目下的专家列表
     */
    private static final String LISTPAGE = "http://kjpt-zuul/stp-proxy/zjkchoice-provider/zjkchoice/zjkchoice-page";
    //返回项目列表
    private static final String getListChoice = "http://kjpt-zuul/stp-proxy/zjkchoice-provider/zjkchoice/getListChoice";
    private static final String LISTPAGE_choice = "http://kjpt-zuul/stp-proxy/zjkchoice-provider/zjkchoice/zjkchoice-page-choice";
    /**
     * 保存
     */
    private static final String SAVE = "http://kjpt-zuul/stp-proxy/zjkchoice-provider/zjkchoice/save_zjkchoice";
