...
public class FileController extends BaseController {
	...
	private static final String managerFileList = "http://kjpt-zuul/system-proxy/file-common-provider/file/kind/list";
	private static final String collectFileList = "http://kjpt-zuul/system-proxy/file-common-provider/files/collect/data-list";
	
	private static final String download = "http://kjpt-zuul/system-proxy/file-common-provider/version/download/";
    private static final String downloads = "http://kjpt-zuul/system-proxy/file-common-provider/version/downloads/";
    
    private static final String errorReplace = "http://kjpt-zuul/system-proxy/file-common-provider/history/error/replace";
