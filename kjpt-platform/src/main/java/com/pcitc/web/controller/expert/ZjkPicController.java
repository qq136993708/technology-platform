...
public class ZjkPicController extends BaseController {
     ...
     * 根据ID获取对象信息
     */
    private static final String GET_INFO = "http://kjpt-zuul/system-proxy/zjkpic-provider/zjkpic/get-zjkpic/";
    /**
     * 树形
     */
    private static final String TREE_DATA = "http://kjpt-zuul/system-proxy/zjkpic-provider/zjkpic/tree-data";
    /**
     * 逻辑删除
     */
    private static final String DEL = "http://kjpt-zuul/system-proxy/zjkpic-provider/zjkpic/del-zjkpic/";
    /**
     * 物理删除
     */
    private static final String DEL_REAL = "http://kjpt-zuul/system-proxy/zjkpic-provider/zjkpic/del-zjkpic-real/";

    /**
     * 查询列表
     */
    private static final String LIST = "http://kjpt-zuul/system-proxy/zjkpic-provider/zjkpic/zjkpic_list";
    /**
     * 参数查询
     */
    private static final String LISTPARAM = "http://kjpt-zuul/system-proxy/zjkpic-provider/zjkpic/zjkpic_list_param";
    /**
     * 分页查询
     */
    private static final String LISTPAGE = "http://kjpt-zuul/system-proxy/zjkpic-provider/zjkpic/zjkpic-page";
    /**
     * 保存
     */
    private static final String SAVE = "http://kjpt-zuul/system-proxy/zjkpic-provider/zjkpic/save_zjkpic";
