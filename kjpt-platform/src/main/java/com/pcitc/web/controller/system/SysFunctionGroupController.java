...
public class SysFunctionGroupController extends BaseController {
	...
	private static final String POST_GET_FUNCTIONGROUP = "http://kjpt-zuul/system-proxy/functiongroup-provider/functiongroup/functiongroup-list";
	private static final String FUNCTIONGROUP_INFO = "http://kjpt-zuul/system-proxy/functiongroup-provider/functiongroup/functiongroup-info/";
	private static final String FUNCTIONGROUP_FUNCTIONS = "http://kjpt-zuul/system-proxy/functiongroup-provider/functiongroup/functiongroup-functions/";
	private static final String POST_GET_FUNCTIONGROUP_TABLE = "http://kjpt-zuul/system-proxy/functiongroup-provider/functiongroup/functiongroup-table";
	
	
	private static final String FUNCTIONGROUP_ADD_AND_UPD = "http://kjpt-zuul/system-proxy/functiongroup-provider/functiongroup/functiongroup-update";
	private static final String FUNCTIONGROUP_DEL = "http://kjpt-zuul/system-proxy/functiongroup-provider/functiongroup/functiongroup-del/";
	private static final String FUNCTIONGROUP_ROLE_UPD = "http://kjpt-zuul/system-proxy/functiongroup-provider/functiongroup/functiongroup-update-functions";
