...
public class SysTableEncodeController extends BaseController {
	...
	// 列表查询
	private static final String TABLE_ENCODE_LIST = "http://kjpt-zuul/system-proxy/tableEncode-provider/tableEncode_list";
	// 保存新增
	private static final String SAVE_TABLE_ENCODE = "http://kjpt-zuul/system-proxy/tableEncode-provider/saveTableEncode";
	// 删除编码
	private static final String DELETE_TABLE_ENCODE = "http://kjpt-zuul/system-proxy/tableEncode-provider/deleteTableEncode/";
	// 删除编码
	private static final String MODIFY_TABLE_ENCODE = "http://kjpt-zuul/system-proxy/tableEncode-provider/modifyTableEncode/";
