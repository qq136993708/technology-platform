...
@Controller
@RequestMapping("zjkZhuanli")
public class ZjkZhuanliController extends BaseController {
    /**
     * 根据ID获取对象信息
     */
    private static final String GET_INFO = "http://kjpt-zuul/stp-proxy/zjkzhuanli-provider/zjkzhuanli/get-zjkzhuanli/";
    /**
     * 树形
     */
    private static final String TREE_DATA = "http://kjpt-zuul/stp-proxy/zjkzhuanli-provider/zjkzhuanli/tree-data";
    /**
     * 逻辑删除
     */
    private static final String DEL = "http://kjpt-zuul/stp-proxy/zjkzhuanli-provider/zjkzhuanli/del-zjkzhuanli/";
    /**
     * 物理删除
     */
    private static final String DEL_REAL = "http://kjpt-zuul/stp-proxy/zjkzhuanli-provider/zjkzhuanli/del-zjkzhuanli-real/";

    /**
     * 查询列表
     */
    private static final String LIST = "http://kjpt-zuul/stp-proxy/zjkzhuanli-provider/zjkzhuanli/zjkzhuanli_list";
    /**
     * 参数查询
     */
    private static final String LISTPARAM = "http://kjpt-zuul/stp-proxy/zjkzhuanli-provider/zjkzhuanli/zjkzhuanli_list_param";
    /**
     * 分页查询
     */
    private static final String LISTPAGE = "http://kjpt-zuul/stp-proxy/zjkzhuanli-provider/zjkzhuanli/zjkzhuanli-page";
    /**
     * 保存
     */
    private static final String SAVE = "http://kjpt-zuul/stp-proxy/zjkzhuanli-provider/zjkzhuanli/save_zjkzhuanli";
     ...
     * @return
     */
    @RequestMapping(value = "/getZjkZhuanliInfo")
    @OperationFilter(modelName = "专家-专利信息", actionName = "根据ID查询对象信息getzjkZhuanliInfo")
    @ResponseBody
    ...
    @ResponseBody
    @OperationFilter(modelName = "专家-专利信息", actionName = "树形查询getZjkZhuanliTreeData()")
    public Object getZjkZhuanliTreeData() throws Exception {
    ...
    @OperationFilter(modelName = "专家-专利信息", actionName = "树形查询getZjkZhuanliTreeData()")
    @ResponseBody
    public String getZjkZhuanliTreeDatas(HttpServletRequest request) throws Exception {
    ...
    @ResponseBody
    public Object delZjkZhuanli() throws Exception {
    ...
    @ResponseBody
    public Object delZjkZhuanliReal() throws Exception {
