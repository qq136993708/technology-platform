layui.use(['form', 'table', 'layer', 'element'], function(){
    ...
    var $ = layui.$, active = {
        ...
        achievementsAdd:function () {
            var obj={
                title:'添加成果',
                url:'/kjpt/expert/achievements_add.html?expertId='+variable.id+'&type=wh',
        ...
        achievementsEdit:function(){
            ...
            var obj={
                title:'编辑成果',
                url:'/kjpt/expert/achievements_add.html?expertId='+variable.id+"&id="+activeData[0].id+'&type=wh',
                tableName:'achievements',
                arr:achievementsArr,
                tableUrl:'/expert-achievement-api/page'
            }
        ...
        patentAdd:function () {
            var obj={
                title:'添加专利',
                url:'/kjpt/expert/patent_add.html?expertId='+variable.id+'&type=wh',
                tableName:'patent',
                arr:patentArr,
        ...
        patentEdit:function(){
            ...
            var obj={
                title:'编辑专利',
                url:'/kjpt/expert/patent_add.html?expertId='+variable.id+"&id="+activeData[0].id+'&type=wh',
                tableName:'patent',
                arr:patentArr,
                tableUrl:'/expert-patent-api/page'
            }
