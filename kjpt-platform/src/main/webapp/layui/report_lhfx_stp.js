...
var pcitcReport = pcitc.report = {
    ...
    , changeTableId: function (data) {
        ...
        console.log("strTableHeadId:"+pcitcReport.strTableHeadId);
        console.log("strTreeTableId:"+strTreeTableId);
    ...
    getStoreModel: function (flag) {//ajax获取收藏内容,赋值
        ...
        $.ajax({
            ...
            // contentType: 'application/json;charset=utf-8',
            dataType: 'json',
            data: {id: pcitcReport.strNameType},
            async: false,
            url: '/reportStore/listParamByUserId',
    ...
    storeModel: function () {//收藏保存
        ...
        $.ajax({
            ...
            dataType: 'json',
            async: false,
            url: '/reportStore/saveReportStoreByUserStp?json=' + encodeURIComponent(JSON.stringify(param)) + "&modelConfigId=" + pcitcReport.strNameType,
            success: function (xx) {
                alert("操作成功");
            },
            error: function (e) {
