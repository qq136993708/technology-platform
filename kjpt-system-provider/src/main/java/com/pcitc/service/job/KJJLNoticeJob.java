...
//科技奖励系统的通知公告
public class KJJLNoticeJob implements Job, Serializable {
		...
		try {
			...
			if (str != null) {
				...
				for (int i = 0; i < jSONArray.size(); i++) {
					...
					notice.setNoticeSystemType("科技奖励系统");
				...
				outNoticeService.insertNoticeDataBatch(insertData, "科技奖励系统");
				System.out.println("======" + DateUtil.dateToStr(new Date(), DateUtil.FMT_SS) + "科技奖励系统通知--保存到本地数据库-结束=========");
			}
