...
public class TaskInstanceServiceImpl implements TaskInstanceService {
    ...
    */
    ...
    public Integer insertDelegate(SysDelegate delegate) {
    	...
    	flowJson.put("auditAgreeMethod", "http://kjpt-zuul/system-proxy/workflow-provider/task/agree/" + uuid);
    	flowJson.put("auditRejectMethod", "http://kjpt-zuul/system-proxy/workflow-provider/task/reject/" + uuid);
