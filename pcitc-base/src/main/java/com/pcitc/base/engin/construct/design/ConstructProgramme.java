 ...
 * @author 
 */
public class ConstructProgramme implements Serializable {
    /**
     * 业务ID
     */
    ...
    public boolean equals(Object that) {
        ...
        ConstructProgramme other = (ConstructProgramme) that;
        return (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId()))
            ...
            && (this.getProgrammeName() == null ? other.getProgrammeName() == null : this.getProgrammeName().equals(other.getProgrammeName()))
            && (this.getProgrammeNumber() == null ? other.getProgrammeNumber() == null : this.getProgrammeNumber().equals(other.getProgrammeNumber()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getProgrammeName() == null) ? 0 : getProgrammeName().hashCode());
        result = prime * result + ((getProgrammeNumber() == null) ? 0 : getProgrammeNumber().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", programmeNumber=").append(programmeNumber);
