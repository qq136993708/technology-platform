...
/**
 * hse_contractor_award
 * @author 
 */
public class ContractorAwardVo implements Serializable {
    /**
     * 业务ID
     */
     ...
     * 奖励单名称
     */
    private String contractorAwardBillName;

    /**
     * 奖励单编码
     */
    private String contractorAwardBillCode;

    /**
     * 奖励单ID
     */
    private String contractorAwardCause;
     ...
     * 奖励对象名称
     */
    private String contractorAwardUnitName;

    /**
     * 奖励对象编码
     */
    private String contractorAwardUnitCode;

    /**
     * 奖励依据
     */
    private String contractorAwardGist;
    ...
    public String getContractorAwardBillName() {
        return contractorAwardBillName;
    }

    public void setContractorAwardBillName(String contractorAwardBillName) {
        this.contractorAwardBillName = contractorAwardBillName;
    }

    public String getContractorAwardBillCode() {
        return contractorAwardBillCode;
    }

    public void setContractorAwardBillCode(String contractorAwardBillCode) {
        this.contractorAwardBillCode = contractorAwardBillCode;
    }

    public String getContractorAwardCause() {
        return contractorAwardCause;
    }

    public void setContractorAwardCause(String contractorAwardCause) {
        this.contractorAwardCause = contractorAwardCause;
    }
    ...
    public String getContractorAwardUnitName() {
        return contractorAwardUnitName;
    }

    public void setContractorAwardUnitName(String contractorAwardUnitName) {
        this.contractorAwardUnitName = contractorAwardUnitName;
    }

    public String getContractorAwardUnitCode() {
        return contractorAwardUnitCode;
    }

    public void setContractorAwardUnitCode(String contractorAwardUnitCode) {
        this.contractorAwardUnitCode = contractorAwardUnitCode;
    }

    public String getContractorAwardGist() {
        return contractorAwardGist;
    }

    public void setContractorAwardGist(String contractorAwardGist) {
        this.contractorAwardGist = contractorAwardGist;
    }
    ...
    public boolean equals(Object that) {
        ...
        ContractorAwardVo other = (ContractorAwardVo) that;
        return (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId()))
            ...
            && (this.getContractorAwardBillName() == null ? other.getContractorAwardBillName() == null : this.getContractorAwardBillName().equals(other.getContractorAwardBillName()))
            && (this.getContractorAwardBillCode() == null ? other.getContractorAwardBillCode() == null : this.getContractorAwardBillCode().equals(other.getContractorAwardBillCode()))
            && (this.getContractorAwardCause() == null ? other.getContractorAwardCause() == null : this.getContractorAwardCause().equals(other.getContractorAwardCause()))
            ...
            && (this.getContractorAwardUnitName() == null ? other.getContractorAwardUnitName() == null : this.getContractorAwardUnitName().equals(other.getContractorAwardUnitName()))
            && (this.getContractorAwardUnitCode() == null ? other.getContractorAwardUnitCode() == null : this.getContractorAwardUnitCode().equals(other.getContractorAwardUnitCode()))
            && (this.getContractorAwardGist() == null ? other.getContractorAwardGist() == null : this.getContractorAwardGist().equals(other.getContractorAwardGist()))
            ...
            && (this.getAwardScore() == null ? other.getAwardScore() == null : this.getAwardScore().equals(other.getAwardScore()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getContractorAwardBillName() == null) ? 0 : getContractorAwardBillName().hashCode());
        result = prime * result + ((getContractorAwardBillCode() == null) ? 0 : getContractorAwardBillCode().hashCode());
        result = prime * result + ((getContractorAwardCause() == null) ? 0 : getContractorAwardCause().hashCode());
        ...
        result = prime * result + ((getContractorAwardUnitName() == null) ? 0 : getContractorAwardUnitName().hashCode());
        result = prime * result + ((getContractorAwardUnitCode() == null) ? 0 : getContractorAwardUnitCode().hashCode());
        result = prime * result + ((getContractorAwardGist() == null) ? 0 : getContractorAwardGist().hashCode());
        ...
        result = prime * result + ((getAwardScore() == null) ? 0 : getAwardScore().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", contractorAwardBillName=").append(contractorAwardBillName);
        sb.append(", contractorAwardBillCode=").append(contractorAwardBillCode);
        sb.append(", contractorAwardCause=").append(contractorAwardCause);
        ...
        sb.append(", contractorAwardUnitName=").append(contractorAwardUnitName);
        sb.append(", contractorAwardUnitCode=").append(contractorAwardUnitCode);
        sb.append(", contractorAwardGist=").append(contractorAwardGist);
