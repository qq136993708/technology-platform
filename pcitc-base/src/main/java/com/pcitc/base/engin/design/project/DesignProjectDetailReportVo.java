...
/**
 * design_project_detail_report
 * @author ms
 */
public class DesignProjectDetailReportVo extends SearchInfo implements Serializable {
    /**
     * 业务ID
     */
     ...
     * 详细设计批复文号
     */
    private String xxsjpfNo;

    /**
     * 详细设计批复日期
     */
    private String xxsjpfDate;
    ...
    public String getXxsjpfNo() {
        return xxsjpfNo;
    }

    public void setXxsjpfNo(String xxsjpfNo) {
        this.xxsjpfNo = xxsjpfNo;
    }

    public String getXxsjpfDate() {
        return xxsjpfDate;
    }

    public void setXxsjpfDate(String xxsjpfDate) {
        this.xxsjpfDate = xxsjpfDate;
    }
    ...
    public String getXxsjsbNo() {
        return xxsjsbNo;
    }

    public void setXxsjsbNo(String xxsjsbNo) {
        this.xxsjsbNo = xxsjsbNo;
    }
