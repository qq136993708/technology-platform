 ...
 * @author 
 */
public class QlfcComBlacklistVo implements Serializable {
    /**
     * 黑名单id
     */
    private String qlfcComBlacklistId;
    ...
    public String getQlfcComBlacklistId() {
        return qlfcComBlacklistId;
    }

    public void setQlfcComBlacklistId(String qlfcComBlacklistId) {
        this.qlfcComBlacklistId = qlfcComBlacklistId;
    }
