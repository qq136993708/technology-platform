...
/**
 * construct_start_report
 * @author 
 */
public class ConstructStartReport implements Serializable {
    /**
     * 业务ID
     */
     ...
     * 开工报告名称
     */
    private String startReportName;

    /**
     * 开工报告编号
     */
    private String startReportNumber;
    ...
    public String getStartReportName() {
        return startReportName;
    }

    public void setStartReportName(String startReportName) {
        this.startReportName = startReportName;
    }

    public String getStartReportNumber() {
        return startReportNumber;
    }

    public void setStartReportNumber(String startReportNumber) {
        this.startReportNumber = startReportNumber;
    }
    ...
    public boolean equals(Object that) {
        ...
        ConstructStartReport other = (ConstructStartReport) that;
        return (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId()))
            ...
            && (this.getStartReportName() == null ? other.getStartReportName() == null : this.getStartReportName().equals(other.getStartReportName()))
            && (this.getStartReportNumber() == null ? other.getStartReportNumber() == null : this.getStartReportNumber().equals(other.getStartReportNumber()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getStartReportName() == null) ? 0 : getStartReportName().hashCode());
        result = prime * result + ((getStartReportNumber() == null) ? 0 : getStartReportNumber().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", startReportName=").append(startReportName);
        sb.append(", startReportNumber=").append(startReportNumber);
