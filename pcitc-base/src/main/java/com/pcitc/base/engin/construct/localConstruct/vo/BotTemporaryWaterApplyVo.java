...
/**
 * bot_temporary_water_apply
 * @author 
 */
public class BotTemporaryWaterApplyVo implements Serializable {
    /**
     * 业务ID
     */
     ...
     * 主管单位ID
     */
    private String competentUnitId;
     ...
     * 临时用水申请单名称
     */
    private String temporaryWaterApplyBillName;

    /**
     * 临时用水申请单编码
     */
    private String temporaryWaterApplyBillCode;

    /**
     * 临时用水开始时间
     */
    private String temporaryWaterStartDatatime;

    /**
     * 临时用水结束时间
     */
    private String temporaryWaterEndDatatime;

    /**
     * 临时用水计划开始时间
     */
    private String temporaryWaterPlanStartDatatime;

    /**
     * 临时用水计划结束时间
     */
    private String temporaryWaterPlanEndDatatime;
     ...
     * 完工检验人
     */
    private String completeCheckUserName;

    /**
     * 临时用水用途
     */
    private String temporaryWaterUse;

    /**
     * 临时用水取水处编号
     */
    private String temporaryWaterNumber;
     ...
     * 用水量
     */
    private String temporaryWaterYield;
    ...
    public String getCompetentUnitCode() {
        return competentUnitCode;
    }

    public void setCompetentUnitCode(String competentUnitCode) {
        this.competentUnitCode = competentUnitCode;
    }

    public String getCompetentUnitId() {
        return competentUnitId;
    }

    public void setCompetentUnitId(String competentUnitId) {
        this.competentUnitId = competentUnitId;
    }
    ...
    public String getTemporaryWaterApplyBillName() {
        return temporaryWaterApplyBillName;
    }

    public void setTemporaryWaterApplyBillName(String temporaryWaterApplyBillName) {
        this.temporaryWaterApplyBillName = temporaryWaterApplyBillName;
    }

    public String getTemporaryWaterApplyBillCode() {
        return temporaryWaterApplyBillCode;
    }

    public void setTemporaryWaterApplyBillCode(String temporaryWaterApplyBillCode) {
        this.temporaryWaterApplyBillCode = temporaryWaterApplyBillCode;
    }

    public String getTemporaryWaterStartDatatime() {
        return temporaryWaterStartDatatime;
    }

    public void setTemporaryWaterStartDatatime(String temporaryWaterStartDatatime) {
        this.temporaryWaterStartDatatime = temporaryWaterStartDatatime;
    }

    public String getTemporaryWaterEndDatatime() {
        return temporaryWaterEndDatatime;
    }

    public void setTemporaryWaterEndDatatime(String temporaryWaterEndDatatime) {
        this.temporaryWaterEndDatatime = temporaryWaterEndDatatime;
    }

    public String getTemporaryWaterPlanStartDatatime() {
        return temporaryWaterPlanStartDatatime;
    }

    public void setTemporaryWaterPlanStartDatatime(String temporaryWaterPlanStartDatatime) {
        this.temporaryWaterPlanStartDatatime = temporaryWaterPlanStartDatatime;
    }

    public String getTemporaryWaterPlanEndDatatime() {
        return temporaryWaterPlanEndDatatime;
    }

    public void setTemporaryWaterPlanEndDatatime(String temporaryWaterPlanEndDatatime) {
        this.temporaryWaterPlanEndDatatime = temporaryWaterPlanEndDatatime;
    }
    ...
    public String getRecoverProgram() {
        return recoverProgram;
    }

    public void setRecoverProgram(String recoverProgram) {
        this.recoverProgram = recoverProgram;
    }
    ...
    public String getCompleteCheckUserName() {
        return completeCheckUserName;
    }

    public void setCompleteCheckUserName(String completeCheckUserName) {
        this.completeCheckUserName = completeCheckUserName;
    }

    public String getTemporaryWaterUse() {
        return temporaryWaterUse;
    }

    public void setTemporaryWaterUse(String temporaryWaterUse) {
        this.temporaryWaterUse = temporaryWaterUse;
    }

    public String getTemporaryWaterNumber() {
        return temporaryWaterNumber;
    }

    public void setTemporaryWaterNumber(String temporaryWaterNumber) {
        this.temporaryWaterNumber = temporaryWaterNumber;
    }
    ...
    public String getTemporaryWaterYield() {
        return temporaryWaterYield;
    }

    public void setTemporaryWaterYield(String temporaryWaterYield) {
        this.temporaryWaterYield = temporaryWaterYield;
    }
    ...
    public boolean equals(Object that) {
        ...
        BotTemporaryWaterApplyVo other = (BotTemporaryWaterApplyVo) that;
        return (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId()))
            ...
            && (this.getCompetentUnitName() == null ? other.getCompetentUnitName() == null : this.getCompetentUnitName().equals(other.getCompetentUnitName()))
            && (this.getCompetentUnitCode() == null ? other.getCompetentUnitCode() == null : this.getCompetentUnitCode().equals(other.getCompetentUnitCode()))
            && (this.getCompetentUnitId() == null ? other.getCompetentUnitId() == null : this.getCompetentUnitId().equals(other.getCompetentUnitId()))
            ...
            && (this.getTemporaryWaterApplyBillName() == null ? other.getTemporaryWaterApplyBillName() == null : this.getTemporaryWaterApplyBillName().equals(other.getTemporaryWaterApplyBillName()))
            && (this.getTemporaryWaterApplyBillCode() == null ? other.getTemporaryWaterApplyBillCode() == null : this.getTemporaryWaterApplyBillCode().equals(other.getTemporaryWaterApplyBillCode()))
            && (this.getTemporaryWaterStartDatatime() == null ? other.getTemporaryWaterStartDatatime() == null : this.getTemporaryWaterStartDatatime().equals(other.getTemporaryWaterStartDatatime()))
            && (this.getTemporaryWaterEndDatatime() == null ? other.getTemporaryWaterEndDatatime() == null : this.getTemporaryWaterEndDatatime().equals(other.getTemporaryWaterEndDatatime()))
            && (this.getTemporaryWaterPlanStartDatatime() == null ? other.getTemporaryWaterPlanStartDatatime() == null : this.getTemporaryWaterPlanStartDatatime().equals(other.getTemporaryWaterPlanStartDatatime()))
            && (this.getTemporaryWaterPlanEndDatatime() == null ? other.getTemporaryWaterPlanEndDatatime() == null : this.getTemporaryWaterPlanEndDatatime().equals(other.getTemporaryWaterPlanEndDatatime()))
            ...
            && (this.getApplyContent() == null ? other.getApplyContent() == null : this.getApplyContent().equals(other.getApplyContent()))
            && (this.getJobProgram() == null ? other.getJobProgram() == null : this.getJobProgram().equals(other.getJobProgram()))
            && (this.getRecoverProgram() == null ? other.getRecoverProgram() == null : this.getRecoverProgram().equals(other.getRecoverProgram()))
            && (this.getCompleteDatatime() == null ? other.getCompleteDatatime() == null : this.getCompleteDatatime().equals(other.getCompleteDatatime()))
            && (this.getCompleteCheckUserName() == null ? other.getCompleteCheckUserName() == null : this.getCompleteCheckUserName().equals(other.getCompleteCheckUserName()))
            && (this.getTemporaryWaterUse() == null ? other.getTemporaryWaterUse() == null : this.getTemporaryWaterUse().equals(other.getTemporaryWaterUse()))
            && (this.getTemporaryWaterNumber() == null ? other.getTemporaryWaterNumber() == null : this.getTemporaryWaterNumber().equals(other.getTemporaryWaterNumber()))
            ...
            && (this.getApplyUserPhone() == null ? other.getApplyUserPhone() == null : this.getApplyUserPhone().equals(other.getApplyUserPhone()))
            && (this.getAnnouncements() == null ? other.getAnnouncements() == null : this.getAnnouncements().equals(other.getAnnouncements()))
            && (this.getTemporaryWaterYield() == null ? other.getTemporaryWaterYield() == null : this.getTemporaryWaterYield().equals(other.getTemporaryWaterYield()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCompetentUnitName() == null) ? 0 : getCompetentUnitName().hashCode());
        result = prime * result + ((getCompetentUnitCode() == null) ? 0 : getCompetentUnitCode().hashCode());
        result = prime * result + ((getCompetentUnitId() == null) ? 0 : getCompetentUnitId().hashCode());
        ...
        result = prime * result + ((getTemporaryWaterApplyBillName() == null) ? 0 : getTemporaryWaterApplyBillName().hashCode());
        result = prime * result + ((getTemporaryWaterApplyBillCode() == null) ? 0 : getTemporaryWaterApplyBillCode().hashCode());
        result = prime * result + ((getTemporaryWaterStartDatatime() == null) ? 0 : getTemporaryWaterStartDatatime().hashCode());
        result = prime * result + ((getTemporaryWaterEndDatatime() == null) ? 0 : getTemporaryWaterEndDatatime().hashCode());
        result = prime * result + ((getTemporaryWaterPlanStartDatatime() == null) ? 0 : getTemporaryWaterPlanStartDatatime().hashCode());
        result = prime * result + ((getTemporaryWaterPlanEndDatatime() == null) ? 0 : getTemporaryWaterPlanEndDatatime().hashCode());
        ...
        result = prime * result + ((getApplyContent() == null) ? 0 : getApplyContent().hashCode());
        result = prime * result + ((getJobProgram() == null) ? 0 : getJobProgram().hashCode());
        result = prime * result + ((getRecoverProgram() == null) ? 0 : getRecoverProgram().hashCode());
        result = prime * result + ((getCompleteDatatime() == null) ? 0 : getCompleteDatatime().hashCode());
        result = prime * result + ((getCompleteCheckUserName() == null) ? 0 : getCompleteCheckUserName().hashCode());
        result = prime * result + ((getTemporaryWaterUse() == null) ? 0 : getTemporaryWaterUse().hashCode());
        result = prime * result + ((getTemporaryWaterNumber() == null) ? 0 : getTemporaryWaterNumber().hashCode());
        ...
        result = prime * result + ((getApplyUserPhone() == null) ? 0 : getApplyUserPhone().hashCode());
        result = prime * result + ((getAnnouncements() == null) ? 0 : getAnnouncements().hashCode());
        result = prime * result + ((getTemporaryWaterYield() == null) ? 0 : getTemporaryWaterYield().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", competentUnitName=").append(competentUnitName);
        sb.append(", competentUnitCode=").append(competentUnitCode);
        sb.append(", competentUnitId=").append(competentUnitId);
        ...
        sb.append(", temporaryWaterApplyBillName=").append(temporaryWaterApplyBillName);
        sb.append(", temporaryWaterApplyBillCode=").append(temporaryWaterApplyBillCode);
        sb.append(", temporaryWaterStartDatatime=").append(temporaryWaterStartDatatime);
        sb.append(", temporaryWaterEndDatatime=").append(temporaryWaterEndDatatime);
        sb.append(", temporaryWaterPlanStartDatatime=").append(temporaryWaterPlanStartDatatime);
        sb.append(", temporaryWaterPlanEndDatatime=").append(temporaryWaterPlanEndDatatime);
        ...
        sb.append(", jobProgram=").append(jobProgram);
        sb.append(", recoverProgram=").append(recoverProgram);
        sb.append(", completeDatatime=").append(completeDatatime);
        sb.append(", completeCheckUserName=").append(completeCheckUserName);
        sb.append(", temporaryWaterUse=").append(temporaryWaterUse);
        sb.append(", temporaryWaterNumber=").append(temporaryWaterNumber);
        ...
        sb.append(", temporaryWaterYield=").append(temporaryWaterYield);
