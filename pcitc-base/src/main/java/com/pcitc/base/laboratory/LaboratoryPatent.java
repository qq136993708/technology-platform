...
public class LaboratoryPatent extends DataEntity implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        LaboratoryPatent other = (LaboratoryPatent) that;
        ...
        return
                (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId())) &&
                        ...
                        (this.getPatentStatus() == null ? other.getPatentStatus() == null : this.getPatentStatus().equals(other.getPatentStatus())) &&

                        (this.getPatentInventor() == null ? other.getPatentInventor() == null : this.getPatentInventor().equals(other.getPatentInventor())) &&
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPatentStatus() == null) ? 0 : getPatentStatus().hashCode());
        result = prime * result + ((getPatentInventor() == null) ? 0 : getPatentInventor().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", patentStatus=").append(patentStatus);
        sb.append(", patentInventor=").append(patentInventor);
