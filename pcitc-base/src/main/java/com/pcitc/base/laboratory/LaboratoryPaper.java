...
public class LaboratoryPaper extends DataEntity implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        LaboratoryPaper other = (LaboratoryPaper) that;
        ...
        return
                (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId())) &&
                        ...
                        (this.getPaperLevel() == null ? other.getPaperLevel() == null : this.getPaperLevel().equals(other.getPaperLevel())) &&

                        (this.getJournalName() == null ? other.getJournalName() == null : this.getJournalName().equals(other.getJournalName())) &&

                        (this.getPaperAuthor() == null ? other.getPaperAuthor() == null : this.getPaperAuthor().equals(other.getPaperAuthor())) &&

                        (this.getPaperYear() == null ? other.getPaperYear() == null : this.getPaperYear().equals(other.getPaperYear())) &&
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPaperLevel() == null) ? 0 : getPaperLevel().hashCode());
        result = prime * result + ((getJournalName() == null) ? 0 : getJournalName().hashCode());
        result = prime * result + ((getPaperAuthor() == null) ? 0 : getPaperAuthor().hashCode());
        result = prime * result + ((getPaperYear() == null) ? 0 : getPaperYear().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", paperLevel=").append(paperLevel);
        sb.append(", journalName=").append(journalName);
        sb.append(", paperAuthor=").append(paperAuthor);
        sb.append(", paperYear=").append(paperYear);
