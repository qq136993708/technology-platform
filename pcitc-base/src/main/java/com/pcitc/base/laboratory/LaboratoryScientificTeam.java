...
public class LaboratoryScientificTeam extends DataEntity implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        LaboratoryScientificTeam other = (LaboratoryScientificTeam) that;
        ...
        return
                (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId())) &&
                        ...
                        (this.getGraduatedUniversity() == null ? other.getGraduatedUniversity() == null : this.getGraduatedUniversity().equals(other.getGraduatedUniversity())) &&
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getGraduatedUniversity() == null) ? 0 : getGraduatedUniversity().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", graduatedUniversity=").append(graduatedUniversity);
