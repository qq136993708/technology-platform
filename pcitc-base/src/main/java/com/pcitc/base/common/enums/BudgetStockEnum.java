...
public enum BudgetStockEnum 
{
	...
	SPLIT_STOCK_XSD(306,"GFFXSD","ROOT_ZGSHJT_GFGS_XSDYFZX","休斯顿"),
	SPLIT_STOCK_ZD(307,"GFFZD","ROOT_ZGSHJT_GFGS_ZDYFZX","中东"),
	SPLIT_STOCK_MYSGZS(308,"MYSGZS","ROOT_ZGSHJT_GFGS_MYSGZS","马永生工作室"),
	
	SPLIT_GROUP_TOTAL(309,"ROOT_JFYS_JTDWFL","GROUP_TOTAL","集团公司"),
	SPLIT_ASSET_TOTAL(310,"ROOT_JFYS_ZCDWFL","ASSET_TOTAL","资产公司");
