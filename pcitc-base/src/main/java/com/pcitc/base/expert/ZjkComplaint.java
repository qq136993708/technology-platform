...
public class ZjkComplaint extends DataEntity implements Serializable {
    ...
    /**
     * complaint_user - 投诉人ID
     */
    private String complaintUser;

    /**
     * complaint_user_name - 投诉人名称
     */
    ...
    public boolean equals(Object that) {
        ...
        ZjkComplaint other = (ZjkComplaint) that;
        ...
        return
                (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId())) &&
                        ...
                        (this.getComplaintUser() == null ? other.getComplaintUser() == null : this.getComplaintUser().equals(other.getComplaintUser())) &&

                        (this.getComplaintUserName() == null ? other.getComplaintUserName() == null : this.getComplaintUserName().equals(other.getComplaintUserName())) &&

                        (this.getComplaintDesc() == null ? other.getComplaintDesc() == null : this.getComplaintDesc().equals(other.getComplaintDesc())) &&

                        (this.getIsComplet() == null ? other.getIsComplet() == null : this.getIsComplet().equals(other.getIsComplet())) &&
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getComplaintUser() == null) ? 0 : getComplaintUser().hashCode());
        result = prime * result + ((getComplaintUserName() == null) ? 0 : getComplaintUserName().hashCode());
        result = prime * result + ((getComplaintDesc() == null) ? 0 : getComplaintDesc().hashCode());
        result = prime * result + ((getIsComplet() == null) ? 0 : getIsComplet().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", complaintUser=").append(complaintUser);
        sb.append(", complaintUserName=").append(complaintUserName);
        sb.append(", complaintDesc=").append(complaintDesc);
        sb.append(", isComplet=").append(isComplet);
