...
/**
 * out_project_contract_item
 * @author 
 */
public class OutProjectContractItem implements Serializable {
    /**
     * 主键
     */
    ...
    public boolean equals(Object that) {
        ...
        OutProjectContractItem other = (OutProjectContractItem) that;
        return (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId()))
            && (this.getContractId() == null ? other.getContractId() == null : this.getContractId().equals(other.getContractId()))
            && (this.getItemFile() == null ? other.getItemFile() == null : this.getItemFile().equals(other.getItemFile()))
            && (this.getItemUrl() == null ? other.getItemUrl() == null : this.getItemUrl().equals(other.getItemUrl()))
            && (this.getItemUnitCode() == null ? other.getItemUnitCode() == null : this.getItemUnitCode().equals(other.getItemUnitCode()))
            && (this.getItemUnit() == null ? other.getItemUnit() == null : this.getItemUnit().equals(other.getItemUnit()))
            && (this.getItemRequire() == null ? other.getItemRequire() == null : this.getItemRequire().equals(other.getItemRequire()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getItemFile() == null) ? 0 : getItemFile().hashCode());
        result = prime * result + ((getItemUrl() == null) ? 0 : getItemUrl().hashCode());
        result = prime * result + ((getItemUnitCode() == null) ? 0 : getItemUnitCode().hashCode());
        result = prime * result + ((getItemUnit() == null) ? 0 : getItemUnit().hashCode());
        result = prime * result + ((getItemRequire() == null) ? 0 : getItemRequire().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", itemFile=").append(itemFile);
        sb.append(", itemUrl=").append(itemUrl);
        sb.append(", itemUnitCode=").append(itemUnitCode);
        sb.append(", itemUnit=").append(itemUnit);
        sb.append(", itemRequire=").append(itemRequire);
