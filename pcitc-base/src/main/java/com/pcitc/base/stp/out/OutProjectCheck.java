 ...
 * @author 
 */
public class OutProjectCheck implements Serializable {
    /**
     * 主键
     */
    ...
    private List<OutProjectCheckItem> itemList;
 
    
    public List<OutProjectCheckItem> getItemList() {
		return itemList;
	}

	public void setItemList(List<OutProjectCheckItem> itemList) {
    ...
    public String getCheckRandom() {
        return checkRandom;
    }

    public void setCheckRandom(String checkRandom) {
    ...
    public boolean equals(Object that) {
        ...
        OutProjectCheck other = (OutProjectCheck) that;
        return (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId()))
            ...
            && (this.getCheckRandom() == null ? other.getCheckRandom() == null : this.getCheckRandom().equals(other.getCheckRandom()))
            && (this.getCheckFile() == null ? other.getCheckFile() == null : this.getCheckFile().equals(other.getCheckFile()))
            && (this.getCheckUrl() == null ? other.getCheckUrl() == null : this.getCheckUrl().equals(other.getCheckUrl()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCheckRandom() == null) ? 0 : getCheckRandom().hashCode());
        result = prime * result + ((getCheckFile() == null) ? 0 : getCheckFile().hashCode());
        result = prime * result + ((getCheckUrl() == null) ? 0 : getCheckUrl().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", checkRandom=").append(checkRandom);
