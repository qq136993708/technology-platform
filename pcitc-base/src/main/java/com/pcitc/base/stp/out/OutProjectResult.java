 ...
 * @author 
 */
public class OutProjectResult implements Serializable {
    /**
     * 主键
     */
    ...
    public boolean equals(Object that) {
        ...
        OutProjectResult other = (OutProjectResult) that;
        return (this.getDataId() == null ? other.getDataId() == null : this.getDataId().equals(other.getDataId()))
            && (this.getProjectId() == null ? other.getProjectId() == null : this.getProjectId().equals(other.getProjectId()))
            && (this.getResultRemarks() == null ? other.getResultRemarks() == null : this.getResultRemarks().equals(other.getResultRemarks()))
            && (this.getResultSign() == null ? other.getResultSign() == null : this.getResultSign().equals(other.getResultSign()))
            && (this.getResultContent() == null ? other.getResultContent() == null : this.getResultContent().equals(other.getResultContent()))
            && (this.getResultFile() == null ? other.getResultFile() == null : this.getResultFile().equals(other.getResultFile()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getResultRemarks() == null) ? 0 : getResultRemarks().hashCode());
        result = prime * result + ((getResultSign() == null) ? 0 : getResultSign().hashCode());
        result = prime * result + ((getResultContent() == null) ? 0 : getResultContent().hashCode());
        result = prime * result + ((getResultFile() == null) ? 0 : getResultFile().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", resultSign=").append(resultSign);
