...
@Service
public class AcademicianServiceImpl implements IAcademicianService {
	
	@Autowired
	private ZjkAcademicianBaseMapper zjkAcademicianBaseMapper;
	@Autowired
	...
	*/
	public ZjkAcademicianBase selectZjkAcademicianBase(String id) throws Exception
	{
		...
		ZjkAcademicianBase zjkBase= zjkAcademicianBaseMapper.selectByPrimaryKey(id);
		return zjkBase;
	}
	...
	public ZjkAcademicianBase getZjkAcademicianBaseByNum(String num) throws Exception
	{
		...
		ZjkAcademicianBase zjkBase= zjkAcademicianBaseMapper.getZjkAcademicianBaseByNum(num);
		return zjkBase;
	}
	...
	*/
	public Integer updateZjkAcademicianBase(ZjkAcademicianBase record)throws Exception
	{
		 ...
		 return zjkAcademicianBaseMapper.updateByPrimaryKey(record);
	}
	...
	public int deleteZjkAcademicianBase(String id)throws Exception
	{
		...
		return zjkAcademicianBaseMapper.deleteByPrimaryKey(id);
	}
	...
	{
		ZjkAcademicianBase sjkBase=zjkAcademicianBaseMapper.selectByPrimaryKey(id);
		...
		return zjkAcademicianBaseMapper.updateByPrimaryKey(sjkBase);
	}
	...
	public Integer insertZjkAcademicianBase(ZjkAcademicianBase record)throws Exception
	{
		...
		record.setTechnicalFieldName(technicalFieldName);
		return zjkAcademicianBaseMapper.insert(record);
	}
	
	
	
	//增加专家相关的信息
	public void addRealtionInfo(ZjkAcademicianBase record)throws Exception
	{
	...
	*/
	public LayuiTableData getZjkAcademicianBasePage(LayuiTableParam param)throws Exception
	{
			...
			List<ZjkAcademicianBase> list = zjkAcademicianBaseMapper.getList(map);
			PageInfo<ZjkAcademicianBase> pageInfo = new PageInfo<ZjkAcademicianBase>(list);
	...
	public List getZjkAcademicianBaseList(Map map)throws Exception
	{
	...
	public Integer outPersonToZjkAcademicianBase(Map map)throws Exception
	{
		...
		if(arr!=null)
		{
			for(int i=0;i<arr.length;i++)
			{
				...
				ZjkAcademicianBase zjkBase = new ZjkAcademicianBase();
				...
				zjkAcademicianBaseMapper.insert(zjkBase);
	...
	*/
	...
	public int insertBatch(List<ZjkAcademicianBase> list)throws Exception
	{
		...
		if(list!=null && list.size()>0)
		{
			...
			{
				ZjkAcademicianBase zjkBase=list.get(i);
				count=zjkAcademicianBaseMapper.insert(zjkBase);
			}
		}
		return count;
	}
