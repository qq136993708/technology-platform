...
//            String patentName = "相关专利" + count_patent + "个";
...
//
//
//                nodes.add(new ChartGraphDataNode(zl_index, name, value,source, itemStyle,getX(zl_x,zl_y,zl_d*i,zl_r),getY(zl_x,zl_y,zl_d*i,zl_r),zl_s_sym+""));
