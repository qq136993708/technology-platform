...
@Api(value="预算-年度预算（股份-付分子公司）分解表",tags= {"预算分解-年度股股预算分解表"})
@RestController
public class BudgetStockSplitZgsProviderClient 
{
	
	private final static Logger logger = LoggerFactory.getLogger(BudgetStockSplitZgsProviderClient.class);
	...
	@ApiOperation(value="股份公司付分子公司预算分解-预算列表",notes="按年检索年度股份预算表列表信息。")
	@RequestMapping(value = "/stp-provider/budget/budget-stocksplit-zgs-info-list", method = RequestMethod.POST)
	...
	@ApiOperation(value="股份公司付分子公司预算分解-预算列表",notes="按年分页检索年度股份预算表列表信息。")
	@RequestMapping(value = "/stp-provider/budget/budget-stocksplit-zgs-info-table", method = RequestMethod.POST)
	public Object selectBudgetStockSplitInfoTable(@RequestBody LayuiTableParam param) 
	{
		...
		try
		{
			param.getParam().put("budget_type", BudgetInfoEnum.STOCK_ZGS_SPLIT.getCode());
	...
	@ApiOperation(value="股份公司付分子公司预算分解-预算表信息检索",notes="检索预算表信息")
	@RequestMapping(value = "/stp-provider/budget/budget-stocksplit-zgs-info", method = RequestMethod.POST)
	...
	@ApiOperation(value="股份公司付分子公司预算分解-创建股份年度预算",notes="创建股份年度预算空白预算表")
	@RequestMapping(value = "/stp-provider/budget/budget-create-blank-stocksplit-zgs", method = RequestMethod.POST)
	public Object createOrUpdateBudgetInfo(@RequestBody BudgetInfo info) 
	{
		logger.info("budget-create-blank-stocksplit-zgs...");
		BudgetInfo rsbean = null;
		try
		{
			info.setBudgetType(BudgetInfoEnum.STOCK_ZGS_SPLIT.getCode());
	...
	@ApiOperation(value="股份公司付分子公司预算分解-预算明细检索",notes="检索股份预算分解明细列表数据")
	@RequestMapping(value = "/stp-provider/budget/budget-stocksplit-zgs-items", method = RequestMethod.POST)
	public Object selectAssetSplitItemTable(@RequestBody LayuiTableParam param) 
	{
		...
		logger.info("select-budget-stocksplit-zgs-items..."+dataId);
	...
	@ApiOperation(value="股份公司付分子公司预算分解-预算明细标题",notes="定义股份预算分解表标题。")
	@RequestMapping(value = "/stp-provider/budget/budget-stocksplit-zgs-titles", method = RequestMethod.POST)
	public Object selectAssetSplitTableTitles(@RequestBody String nd) 
	{
		...
		try
		{
			data =  budgetStockSplitZgsSplitService.selectBudgetSplitTableTitles(nd);
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	@ApiOperation(value="股份公司付分子公司预算分解-预算明细标题",notes="定义股份预算历史数据分解表标题（往年和历年数据标题）。")
	@RequestMapping(value = "/stp-provider/budget/budget-stocksplit-zgs-history-titles", method = RequestMethod.POST)
	public Object selectAssetSplitTableHistoryTitles(@RequestBody String nd) 
	{
		logger.info("budget-stocksplit-zgs-history-titles..."+nd);
		Map<String,List<SplitItemVo>> data = null;
		try
		{
			data =  budgetStockSplitZgsSplitService.selectBudgetSplitHistoryTableTitles(nd);
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	@RequestMapping(value = "/stp-provider/budget/save-stocksplit-zgs-item", method = RequestMethod.POST)
	public Object saveBudgetStockSplitItem(@RequestBody String item) 
	{
		...
		try
		{
			...
			List<BudgetSplitData> datas = budgetStockSplitZgsSplitService.saveBudgetSplitDataItem(item);
			rs = datas.size();
		}
		catch (Exception e)
		{
	...
	@ApiOperation(value="股份公司付分子公司预算-保存年度预算项详情",notes="保存预算项不包括子项")
	@RequestMapping(value = "/stp-provider/budget/save-stocksplit-zgs-items", method = RequestMethod.POST)
	public Object saveBudgetStockSplitItems(@RequestBody String items) 
	{
		logger.info("budget-save-stocksplit-zgs-items...");
		Integer rs = 0;
		try
		{
			List<BudgetSplitData> datas = budgetStockSplitZgsSplitService.saveBudgetSplitDataItems(items);
			rs = datas.size();
		}
		catch (Exception e)
		{
	...
	@ApiOperation(value="股份公司付分子公司预算-删除股份年度预算",notes="删除股份年度预算表（逻辑删除）")
	@RequestMapping(value = "/stp-provider/budget/budget-stocksplit-zgs-del", method = RequestMethod.POST)
	public Object deleteBudgetGroupTotalInfo(@RequestBody BudgetInfo info) 
	{
		...
		try
		{
			...
			rs += budgetStockSplitZgsSplitService.deleteBudgetSplitDataByInfo(info.getDataId());
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	@ApiOperation(value="股份公司付分子公司预算分解-检索预算项详情",notes="检索预算项详情包括子项详情")
	@RequestMapping(value = "/stp-provider/budget/get-stocksplit-zgs-item", method = RequestMethod.POST)
	public Object selectBudgetGroupTotalItem(@RequestBody BudgetSplitBaseDataVo vo) 
	{
		logger.info("get-stocksplit-zgs-item...");
		Map<String,Object> map = new HashMap<String,Object>();
		try
		{
			System.out.println(JSON.toJSONString(vo));
			System.out.println("--------------");
			map = budgetStockSplitZgsSplitService.selectAssetSplitItem(vo.getBudgetInfoId(),vo.getOrganCode());
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	@ApiOperation(value="股份公司付分子公司预算分解-检索预算项历史数据",notes="检索预算项历史数据列表")
	@RequestMapping(value = "/stp-provider/budget/get-stocksplit-zgs-history-items", method = RequestMethod.POST)
	public Object selectBudgetStockSplitHistoryItems(@RequestBody BudgetSplitBaseDataVo vo) 
	{
		...
		try
		{
			List<BudgetInfo> infos = budgetInfoService.selectFinalBudgetInfoList(BudgetInfoEnum.STOCK_ZGS_SPLIT.getCode());
			for(BudgetInfo info:infos) {
				//System.out.println("nd:"+info.getNd()+"  organCode:"+vo.getOrganCode());
				rslist.add(budgetStockSplitZgsSplitService.selectAssetSplitFinalItem(info.getNd(),vo.getOrganCode()));
			}
		}
		catch (Exception e)
		{
	...
	@ApiOperation(value="股份公司付分子公司预算分解-检索预算项历年数据",notes="检索预算项历年数据列表不包括子项")
	@RequestMapping(value = "/stp-provider/budget/search-stocksplit-zgs-final-history-list", method = RequestMethod.POST)
	public Object selectBudgetStockFinalHistoryList() 
	{
		List<Map<String,Object>> rsmap = new ArrayList<Map<String,Object>>();
		try
		{
			List<BudgetInfo> rs = budgetInfoService.selectFinalBudgetInfoList(BudgetInfoEnum.STOCK_ZGS_SPLIT.getCode());
			for(BudgetInfo info:rs) {
				Map<String,Object> map  = MyBeanUtils.transBean2Map(info);
				List<Map<String,Object>> items =  budgetStockSplitZgsSplitService.selectBudgetSplitDataList(info.getDataId());
				map.put("items", items);
				rsmap.add(map);
			}
		}
	...
	@ApiOperation(value="股份公司付分子公司预算分解-股份预算审批",notes="发起股份预算表审批")
	@RequestMapping(value = "/stp-provider/budget/start-budget-stocksplit-zgs-activity/{budgetInfoId}", method = RequestMethod.POST)
	...
	@ApiOperation(value="股份公司付分子公司预算分解-审批流程回调通知",notes="审批结果回调通知")
	@RequestMapping(value = "/stp-provider/budget/callback-workflow-stocksplit-zgs-notice")
